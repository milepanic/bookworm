...
1418 River Drive, Suite 35 Cottonhall, CA 9622 <br> United States
                ...
                <div class="col-lg-2 mb-5 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="pb-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">About
                                as</a>
                        </li>
                        <li class="py-2">
                        ...
                        <li class="py-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover"
                                href="#">Bookmarks</a>
                        </li>
                        <li class="pt-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Sign
                                in/Join</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 mb-5 mb-md-0">
                    <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1 text-gray-500">Customer
                        Service</h4>
                    <ul class="list-unstyled mb-0">
                        <li class="pb-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Help
                                Center</a>
                        </li>
                        <li class="py-2">
                        ...
                        <li class="py-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Product
                                Recalls</a>
                        </li>
                        <li class="py-2">
                        ...
                        <li class="py-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Contact
                                Us</a>
                        </li>
                        <li class="pt-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Store
                                Pickup</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 mb-5 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="pb-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Return
                                Policy</a>
                        </li>
                        <li class="py-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Terms Of
                                Use</a>
                        </li>
                        <li class="py-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover"
                ...
                <div class="col-lg-2 mb-5 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="pt-2">
                            <a class="font-size-2 text-white widgets-hover transition-3d-hover" href="#">Romantic
                                Comedy</a>
                        </li>
                    </ul>
                </div>
